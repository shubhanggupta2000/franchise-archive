...
export const starTrek: Franchise = {
  ...
  description:
    "One of the largest science-fiction franchises ever created, spanning centuries of Federation history across television, films, animation and officially produced Special-form stories.",
  accent: "#1565C0",
  ...
  entries: [
    ...
    // ============================================================
    // Special TREKS — 23RD CENTURY
    // ============================================================

    {
      id: "Special-treks-runaway",
      title: "Star Trek: Special Treks — Runaway",
      year: 2018,
    ...
    {
      id: "Special-treks-calypso",
      title: "Star Trek: Special Treks — Calypso",
      year: 2018,
    ...
    {
      id: "Special-treks-brightest-star",
      title: "Star Trek: Special Treks — The Brightest Star",
      year: 2018,
    ...
    {
      id: "Special-treks-escape-connexion",
      title: "Star Trek: Special Treks — Escape Artist",
      year: 2019,
    ...
    {
      id: "Special-treks-q-a",
      title: "Star Trek: Special Treks — Q&A",
      year: 2019,
    ...
    {
      id: "Special-treks-the-trouble-with-edward",
      title: "Star Trek: Special Treks — The Trouble with Edward",
      year: 2019,
    ...
    {
      id: "Special-treks-ask-not",
      title: "Star Trek: Special Treks — Ask Not",
      year: 2019,
    ...
    {
      id: "Special-treks-children-of-mars",
      title: "Star Trek: Special Treks — Children of Mars",
      year: 2020,
...

    {
      ...
      timeline: "2376",
      synopsis:
        "Voyager's crew encounters new threats and civilizations while gradually Specialening the distance to Earth.",
    },
    ...
    {
      id: "very-Special-treks-fabrication",
      title: "Very Special Treks — Skin a Cat",
      year: 2023,
    ...
    {
      id: "very-Special-treks-holograms",
      title: "Very Special Treks — Holiday",
      year: 2023,
    ...
    {
      id: "very-Special-treks-passion",
      title: "Very Special Treks — Worst Contact",
      year: 2023,
    ...
    {
      id: "very-Special-treks-escape",
      title: "Very Special Treks — Room for Growth",
      year: 2023,
    ...
    {
      id: "very-Special-treks-historic",
      title: "Very Special Treks — One Night in Sickbay",
      year: 2023,
